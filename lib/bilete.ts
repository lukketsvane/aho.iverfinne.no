...
export const BILETE: Bilete[] = [
  {
    slug: "00_pre1953_maridalsveien_casparis_gate_alt_nb_jac_brun",
    tittel: "Maridalsveien-området (alternativ)",
    year: null,
    seksjon: "historie",
    media_url: "https://upload.wikimedia.org/wikipedia/commons/b/ba/Oslo_-_no-nb_digifoto_20150213_00009_NB_MIT_FNR_13571.jpg",
    kjeldeside: "https://commons.wikimedia.org/wiki/File:Oslo_-_no-nb_digifoto_20150213_00009_NB_MIT_FNR_13571.jpg",
    kreditering: "Jac Brun / Nasjonalbiblioteket via Wikimedia Commons",
    lisens: "uklart",
    alt: "Historisk gatefoto frå Maridalsveien-/Casparis gate-området, alternativ vinkel.",
    breidd: 7210,
    hogd: 5410,
  },
  {
    slug: "00_pre1953_maridalsveien_casparis_gate_nb_jac_brun",
    tittel: "Maridalsveien før AHO",
    year: null,
    seksjon: "historie",
    media_url: "https://upload.wikimedia.org/wikipedia/commons/0/00/Oslo_-_no-nb_digifoto_20150213_00005_NB_MIT_FNR_13570.jpg",
    kjeldeside: "https://commons.wikimedia.org/wiki/File:Oslo_-_no-nb_digifoto_20150213_00005_NB_MIT_FNR_13570.jpg",
    kreditering: "Jac Brun / Nasjonalbiblioteket via Wikimedia Commons",
    lisens: "uklart",
    alt: "Historisk gatefoto frå Maridalsveien-området i Oslo, teke før 1953.",
    breidd: 7210,
    hogd: 5410,
  },
  {
  ...
  },
  {
    ...
    kreditering: "Sidsel Moum / NAPsidsel / Wikimedia Commons",
    lisens: "CC BY 3.0",
