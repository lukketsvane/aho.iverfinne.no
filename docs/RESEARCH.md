...
Prize). Brukt som grunnlag for hendingane i [`lib/timeline.ts`](../lib/timeline.ts).
Punkt som **ikkje** er løfta til eigne hendingar enno, er merka «kandidat».

## 1. Datofesta hendingar
...
| 1968 | Flytting frå SHKS til St. Olavs gate | ✓ | SNL/wikipedia |
| 1969 | Namnet Arkitekthøgskolen i Oslo (AHO) | ✓ | SNL |
| 1971 | Sverre Fehn professor ved AHO (til 1995) | ✓ (1997) | NBL |
| 1979 | Industridesign som toårig etterutdanning | ✓ | AHO |
| 1983 | Industridesign på fulltid | ✓ | AHO |
| 1989 | Industridesign lagt under Statens handverks- og kunstindustriskule | kandidat | en.wikipedia |
...
| 2009 | Institutt for industridesign → Institutt for design | ✓ | en.wikipedia |
| 2021 | 75-årsjubileum (markert 12. nov 2021) | kandidat | arkitektur.no |
| 2025 | 80-årsjubileum | ✓ | aho.no |

### Usikkert / sprik mellom kjelder
...
> Rektor-rekkja er ikkje fullstendig verifisert og er difor ikkje lagt inn som
...
- **Fire institutt**: Arkitektur · Design · Form, teori og historie ·
  Urbanisme og landskap. *(en.wikipedia)*
- Om lag **650 studentar**, **~50 ph.d.-studentar**, **~100 administrativt tilsette**.
- Program: Master i arkitektur, master i design, master i landskapsarkitektur
  (Oslo + UiT Tromsø), erfaringsbasert master i urbanisme og i
  arkitekturvern, ph.d. *(en.wikipedia)*
- AHO-jubileumsbok lansert i samband med jubileet. *(arkitektnytt.no)*

## 5. Kjelder

- Store norske leksikon: [AHO](https://snl.no/Arkitektur-_og_designh%C3%B8gskolen_i_Oslo) ·
  [Statens arkitektkurs](https://snl.no/Statens_arkitektkurs) ·
  [Jarmund/Vigsnæs](https://snl.no/Jarmund/Vigsn%C3%A6s_-_arkitektkontor)
- Norsk biografisk leksikon: [Norberg-Schulz](https://nbl.snl.no/Christian_Norberg-Schulz) ·
